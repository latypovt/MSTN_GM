...
def main(): 
    ...
    plt.legend(loc='upper right', title='Diagnosis', fontsize='medium')
    ...
    ax[1, 0].legend(loc='upper right', title='Duration of MS', fontsize='small')
    ...
    ax[0, 0].legend(loc='upper right', title='Sex', fontsize='small')
    ...
    ax[0, 1].legend(loc='upper right', title='Scanner', fontsize='small')
    ...
    ax[1, 1].legend(loc='upper right', title='Age', fontsize='small')
