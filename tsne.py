...
def main(): 
    ...
    morphological_data = ml_dataframe.drop(columns=['id', 'age', 'sex', 'diagnosis', 'duration_of_ms', 'duration_categories', 'duration_of_pain', 'side_of_pain','edss', 'edss_categories'])
    ...
    with plt.xkcd():
      ...
      sns.scatterplot(ax=ax[0, 0], data=tsne_df, x="Dim_1", y="Dim_2", hue='age', sizes=5, alpha=0.8)
      ax[0, 0].legend(loc='upper right', title='age', fontsize='xx-small')
      sns.scatterplot(ax=ax[0, 1], data=tsne_df, x="Dim_1", y="Dim_2", hue='sex', sizes=5, alpha=0.8)
      ax[0, 1].legend(loc='upper right', title='sex', fontsize='xx-small')
      sns.scatterplot(ax=ax[1, 0], data=tsne_df, x="Dim_1", y="Dim_2", hue='duration_categories', sizes=5, alpha=0.8)
      ax[1, 0].legend(loc='upper right', title='duration', fontsize='xx-small')
      sns.scatterplot(ax=ax[1, 1], data=tsne_df, x="Dim_1", y="Dim_2", hue='edss_categories', sizes=5, alpha=0.8)
      ax[1, 1].legend(loc='upper right', title='edss', fontsize='xx-small')
